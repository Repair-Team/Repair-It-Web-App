<template>
  <div :class="containerClass" @click="onWrapperClick">
    ...
    <div class="layout-sidebar" @click="onSidebarClick" v-for="user in users">

      <div v-if="user.isTechnician">
        <AppMenu :model="TechnicianMenu" @menuitem-click="onMenuItemClick" />
      </div>
      <div v-else>
        <AppMenu :model="CustomerMenu" @menuitem-click="onMenuItemClick" />
      </div>
...
export default {
  ...
  async created() {
    //const users = [];
    //const user = users[0]; // this is fine
    //user = 
